...
создаётся при каждой регистрации устройства, и вкладка **Настройки →
Политика выдачи** им не управляет. Одобрение заявки при этом обязательно —
автоматически не выдаётся ни одна цель.
