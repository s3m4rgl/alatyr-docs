...
Страница для того, кто разворачивает Alatyr и должен назвать цифры: сколько
процессора, памяти и диска просить под сервер, базу и Vault. Для настройки
целей она не нужна.
...
!!! note "Ресурсы — не лицензионный лимит"
    ...
    их обслуживать. См. [Лицензирование](licensing.md).
