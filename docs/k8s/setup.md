...
1. Откройте **Настройки → Политика выдачи** и убедитесь, что выдача
   пользовательских целей включена. Если она включена не для всего парка
   машин, а точечно — откройте **Устройства**, раскройте строку нужной машины
   и в блоке **«Политика выдачи для этого устройства»** выберите `both`.
