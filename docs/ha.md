...
Страница для того, кто решает, разворачивать ли сервер в нескольких
репликах. Ответ здесь не «да» и не «нет»: часть путей это выдержит, часть —
нет, и разница существенна.
