...
Интерактивного «окна доверия» для подписи SSH на Linux **нет** — и подавлять
здесь нечего: доступ к значению авторизации токена TPM и так неинтерактивен,
каждая подпись проходит без повторного вопроса пользователю.
