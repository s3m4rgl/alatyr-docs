...
| `alatyr-deploy-<версия>.tar.gz` в [выпусках](https://github.com/s3m4rgl/alatyr-docs/releases) | **Рекомендуемый путь с v1.5.4.** Набор развёртывания: compose со встроенным корневым и промежуточными УЦ, `first-up.sh` печатает учётные данные, тег образов вписан |
