...
Демо-состав поднимает всё сам: PostgreSQL, Vault с настроенным PKI, сервер,
...
токен Vault заданы прямо в файле, чтобы демо-состав поднимался одной командой, —
...
| [`docker-compose.demo.yml`](docker-compose.demo.yml) | Демонстрационный состав одной командой |
