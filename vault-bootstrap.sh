#!/bin/sh
# Инициализация встроенного УЦ для самостоятельной поставки (GitLab dexion #784).
#
...
# и с `allow_any_name` второго рубежа нет вовсе (#391). Здесь роли сужены по
...
# vpn: свой издатель обязателен, а не общий с user_mtls (GitLab dexion #788).
